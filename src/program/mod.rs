...
impl<'a> Program<'a> {
    ...
    fn calc_x_step(&self) -> f32 {
        ...
        if self.ui_state.scale * src_w as f32 > dst_w as f32 {
            (PAN_PIXELS / (self.ui_state.scale * src_w as f32)) / (1.0 - (dst_w as f32 / src_w as f32 * self.ui_state.scale))
        } else {
            (PAN_PIXELS / dst_w as f32) / (1.0 - (src_w as f32 * self.ui_state.scale / dst_w as f32))
    ...
    fn calc_y_step(&self) -> f32 {
        ...
        if self.ui_state.scale * src_h as f32 > dst_h as f32 {
            (PAN_PIXELS / (self.ui_state.scale * src_h as f32)) / (1.0 - (dst_h as f32 / src_h as f32 * self.ui_state.scale))

        } else {
            (PAN_PIXELS / dst_h as f32) / (1.0 - (src_h as f32 * self.ui_state.scale / dst_h as f32))
